...
class VFB_Pro_Upload {
		...
		if ( is_array( $file['name'] ) ) {
			foreach ( $file['name'] as $key => $val ) {
				if ( $file['name'][ $key ] ) {
					...
					$this->insert_attachment( $tmp_upload );
	 ...
	 * @return void
	 */
	private function insert_attachment( $upload ) {
		...
		$attach_id = wp_insert_attachment( $media_upload, $upload['file'], $post_id );
