...
class VFB_Pro_Page_Settings {
	...
	<div class="wrap">
		...
		<form method="post" id="vfbp-settings" action="">
			...
			<table class="form-table">
				...
				<tr valign="top">
					<th scope="row">
						<label for="smtp-test"><?php esc_html_e( 'Send Test Email', 'vfb-pro' ); ?></label>
					</th>
					<td>
	...
	public function smtp_test_init( $phpmailer ) {
		$smtp_host         = isset( $_POST['smtp-host']       ) ? $_POST['smtp-host']       : '';
		$smtp_port         = isset( $_POST['smtp-port']       ) ? $_POST['smtp-port']       : '';
		$smtp_encryption   = isset( $_POST['smtp-encryption'] ) ? $_POST['smtp-encryption'] : '';
		$smtp_auth         = isset( $_POST['smtp-auth']       ) ? $_POST['smtp-auth']       : '';
		$smtp_username     = isset( $_POST['smtp-username']   ) ? $_POST['smtp-username']   : '';
		$smtp_password     = isset( $_POST['smtp-password']   ) ? $_POST['smtp-password']   : '';
