<div <?php post_class('blog-home-post'); ?> id="post-<?php the_ID(); ?>">
	<div class="post_content">
		...
		<div class="vid-wrap"><iframe src="http://player.vimeo.com/video/<?php echo get_post_meta($post->ID, '_dc_media_vimeo', true);?>?portrait=0" width="600" height="335" frameborder="0"></iframe></div>
			<?php } elseif (get_post_meta($post->ID, '_dc_media_youtube', true) != '') { ?>
		<div class="vid-wrap"><iframe width="600" height="335" src="http://www.youtube.com/embed/<?php echo get_post_meta($post->ID, '_dc_media_youtube', true);?>?wmode=opaque" frameborder="0" allowfullscreen></iframe></div>
			<?php } ?>
