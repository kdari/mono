	...
	function optionsframework_wp_head() { 
		...
		//Styles
	     ...
	     if ($style != '') {
	          ...
	          echo '<link href="'. cap_DIRECTORY .'/styles/'. $GLOBALS['stylesheet'] . '.css" rel="stylesheet" type="text/css" />'."\n"; 
	     } else { 
	          $GLOBALS['stylesheet'] = get_option('cap_alt_stylesheet');
	          if($GLOBALS['stylesheet'] != '')
	               echo '<link href="'. cap_DIRECTORY .'/styles/'. $GLOBALS['stylesheet'] .'" rel="stylesheet" type="text/css" />'."\n";         
	          else
	               echo '<link href="'. cap_DIRECTORY .'/styles/default.css" rel="stylesheet" type="text/css" />'."\n";         		  
	     }       
...
add_filter('body_class','cap_body_class');
 
function cap_body_class($classes) {
	$shortname =  get_option('cap_shortname');
