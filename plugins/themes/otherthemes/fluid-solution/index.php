<?php get_header(); ?>
	...
	<div class="postinfo">Filed under <?php the_category(', ') ?> having <?php comments_popup_link('No Comments &raquo;', '1 Comment &raquo;', '% Comments &raquo;'); ?><?php edit_post_link('Edit',' | ',''); ?></div>
