...
require_once dirname(__FILE__) . '/WpLatteTranslator.php';
...
class WpLatte extends NFileTemplate
{
	...
	public function __construct($file, $params)
	{
		...
		$this->setTranslator(new WpLatteTranslator);
	 ...
	 */
	public static function createCustomPostEntity($what, $category = 0, $limit = null, $order = 'menu_order')
	{
		return WpLatteSiteEntity::createCustomPostEntity($what, $category, $limit, $order);
	}
