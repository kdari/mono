...
function aitTopStripPostType()
{
	register_post_type( 'ait-top-strip',
		array(
			'labels' => array(
				'name'			=> __('Top strips' , THEME_CODE_NAME),
				'singular_name' => __('Top strip' , THEME_CODE_NAME),
				'add_new'		=> __('Add new', THEME_CODE_NAME),
				'add_new_item'	=> __('Add new strip', THEME_CODE_NAME),
				'edit_item'		=> __('Edit strip', THEME_CODE_NAME),
				'new_item'		=> __('New strip', THEME_CODE_NAME),
				'not_found'		=> __('No strips found', THEME_CODE_NAME),
				'not_found_in_trash' => __('No strips found in Trash', THEME_CODE_NAME),
				'menu_name'		=> __('Top-Strips'),
			),
			'description' => __('Manipulating with top strips'),
			'public' => false,
...
function aitTopStripTaxonomies()
{
	...
	register_taxonomy( 'ait-top-strip-category', array( 'ait-top-strip' ), array(
		'hierarchical' => true,
		'labels' => array(
			'name'			=> _x( 'Top Strip Categories', 'taxonomy general name' ),
...
function aitTopStripFeaturedImageMetabox()
{
	...
	add_meta_box('postimagediv', __('Icon for strip'), 'post_thumbnail_meta_box', 'ait-top-strip', 'normal', 'high');
}
...
(
	'id' => '_ait-top-strip',
	'title' => __('Options for top strip'),
...
function aitTopStripChangeColumns($cols)
{
	$cols = array(
		...
		'title'			=> __( 'Title' ),
		'top_strip_text'			=> __( 'Text' ),
		'top_strip_link'			=> __( 'Link' ),
		'thumbnail'		=> __( 'Image' ),
		'menu_order'	=> __( 'Order' ),
