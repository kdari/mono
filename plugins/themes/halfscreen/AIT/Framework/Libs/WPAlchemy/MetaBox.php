...
class WPAlchemy_MetaBox
{
	...
	<?php else: ?>
		...
		<?php if(is_string($value) and $value == 'section'): ?>
		...
		<table>
			<tr>
				...
				<td width="20%" style="padding-left:10px">
					<input type="button" value="Select Image" class="media-select  ait-<?php echo $key; ?>-option" id="ait-<?php echo $this->id . "-$key"; ?>_selectMedia">
				</td>
			</tr>
		</table>
		<?php
