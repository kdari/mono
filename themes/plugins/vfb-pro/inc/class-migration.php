...
class VFB_Pro_Migration {
	...
	public function __construct() {
		add_action( 'admin_notices', array( $this, 'check_installed_plugins' ) );
	...
	/**
	 * check_installed_plugins function.
	 *
	 * @access public
	 * @return void
	 */
	public function check_installed_plugins() {
		...
		if ( is_plugin_active( 'visual-form-builder/visual-form-builder.php' ) ) {
			printf(
				...
				__( 'The free version of Visual Form Builder is still active. Please deactivate Visual Form Builder.' , 'vfb-pro' ) );
		}
		...
		if ( is_plugin_active( 'visual-form-builder-pro/visual-form-builder-pro.php' ) ) {
			printf(
				'<div id="message" class="error"><p>%s</p></div>',
				__( 'WARNING: An older version of Visual Form Builder Pro is still active.' , 'vfb-pro' ) );
		}
	}
