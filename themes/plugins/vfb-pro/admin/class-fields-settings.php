...
class VFB_Pro_Admin_Fields_Settings {
	...
	/**
	 * Heading type edit display
	 *
	 * @access public
	 * @param mixed $field
	 * @return void
	 */
	public function heading_type( $field ) {
		$id    = $field['id'];
		$value = isset( $field['data']['heading-type'] ) ? $field['data']['heading-type'] : '';
	?>
		<div class="vfb-form-group">
			...
			<select name="vfb-field-<?php echo $id; ?>[heading-type]" class="vfb-form-control" id="vfb-edit-heading-type-<?php echo $id; ?>">
