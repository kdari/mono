...
class VFB_Pro_Admin_Scripts_Loader {
	...
	public function add_css() {
		...
		wp_enqueue_style( 'vfb-admin', VFB_PLUGIN_URL . "admin/assets/css/vfb-admin.min.css", array(), '2015.03.04' );
	}
	...
	public function add_js() {
		...
		wp_enqueue_script( 'vfb-admin', VFB_PLUGIN_URL . "admin/assets/js/vfb-admin.min.js", array( 'jquery' ), '2015.03.31', true );
