...
array(
	...
	"_portfolio_item_size" => array(
		...
		"type" => "select",
		"options" => array(
			array( "value" => "four columns", "text" => "1/4 of full width" ),
			array( "value" => "one-third column", "text" => "1/3 of full width" ),
			array( "value" => "eight columns", "text" => "1/2 of full width" ),
		),
		"location" => "Portfolio"
	),
...
function new_meta_boxes( $type ) {
    ...
    echo '<input type="hidden" name="Reverence_meta_box_nonce" value="', wp_create_nonce(basename(__FILE__)), '" />';
...
function create_meta_box() {
	...
	if ( function_exists('add_meta_box') ) {
		add_meta_box( 'new_meta_boxes_page', 'Reverence'  . ' Page Settings', 'new_meta_boxes_page', 'page', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_slider', 'Reverence'  . ' Slider Settings', 'new_meta_boxes_slider', 'slider', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_post', 'Reverence'  . ' Post Settings', 'new_meta_boxes_post', 'post', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_portfolio', 'Reverence'  . ' Portfolio Settings', 'new_meta_boxes_portfolio', 'portfolio', 'normal', 'high' );
	}
}

function save_postdata( $post_id ) {
	
	if ( !wp_verify_nonce(isset($_POST['Reverence_meta_box_nonce']) ? $_POST['Reverence_meta_box_nonce'] : '', basename(__FILE__)) ) {
