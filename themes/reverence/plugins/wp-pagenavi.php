...
function wp_pagenavi($before = '', $after = '') {
	...
	$pagenavi_options = array(
		...
		'first_text' => __('','wp-pagenavi'),
		'last_text' => __('','wp-pagenavi'),
...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		...
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('','Reverence'),
		'last_text' => __('','Reverence'),
		'next_text' => __('','Reverence'),
		'prev_text' => __('','Reverence'),
		'dotright_text' => __('...','Reverence'),
		'dotleft_text' => __('...','Reverence'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
		'num_larger_page_numbers' => 3,
