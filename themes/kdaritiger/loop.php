...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 'kdaritiger') ) ) : ?>
...
<?php else : ?>			
				...
				?>
						...
						<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'kdaritiger' ),
								'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'kdaritiger' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
								$total_images
							); ?></em></p>
				<?php endif; ?>
						<?php the_excerpt(); ?>
<?php endif; ?>
			...
			<div class="entry-utility">
				<a href="<?php echo get_term_link( _x('gallery', 'gallery category slug', 'kdaritiger'), 'category' ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 'kdaritiger' ); ?>"><?php _e( 'More Galleries', 'kdaritiger' ); ?></a>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'kdaritiger') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
