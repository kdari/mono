...
<p><span class="commentsfeed"><?php post_comments_feed_link(__('<abbr title="Really Simple Syndication">RSS</abbr> feed for comments on this post.')); ?></span>
<?php if ( pings_open() ) : ?><span class="trackback">
	<a href="<?php trackback_url() ?>" rel="trackback"><?php _e('TrackBack <abbr title="Universal Resource Locator">URL</abbr>'); ?></a></span>
<?php endif; ?>
</p>
