...
function frame( $params, $content = null ) {
	...
	if($ver=='1'){
		$result .= '<div class="frame '.$version.'"'.$bg.'>'.$cl.'<div class="frame-wrap" style="'.$closedStyle.'"><div class="frame-inner">';
	} elseif($ver=='2') {
		$result .= '<div class="frame '.$version.'">'.$cl.'<div class="frame-wrap" style="'.$bg.$closedStyle.'"><div class="frame-inner">';
	}
