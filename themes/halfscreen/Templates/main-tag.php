...
<div id="container" class="subpage defaultContentWidth subpage-line clear">
		...
		<div id="content-wrapper">
			...
			{if $posts}
				...
				<header class="page-header">
					<h1 class="page-title">
						{_}Tag Archives: {/_}<span>{$tag->title}</span>
					</h1>
	...
	<div class="sidebar">
    {block sidebar}
  		{include snippet-sidebar.php, widgets => $site->widgets('blog'), templateType => tag, override => $post->options('page_sidebar')->overrideGlobalSidebars}
		{/block}
	</div><!-- end of sidebar -->
