...
<?php if (_sg('Page')->getTopType() == 'team') { ?>
	<?php
		query_posts('post_type=our-team&posts_per_page=-1&order=ASC');
		$cur = 0;
				...
				<div class="team">
					<?php while (have_posts()) : the_post(); ?>
						...
						<div class="item-holder1<?php if (($cur % $count) == 0) echo ' omega'; ?>">
							...
							<div class="descr">
								<h5><?php the_title(); ?></h5>
								<p class="clr"><?php echo $ot_person->position; ?></p>
								<?php the_content(); ?>
							</div>
	...
	<div class="inner clearfix">
		<div class="inner-t">
			<?php if (have_posts()) { ?>
				<div class="col1-3">
        	        <div class="heading">
    	                <h3><?php _e('Our latest works', SG_TDN) ?></h3>
	                </div>
