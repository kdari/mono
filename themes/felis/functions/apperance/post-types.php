...
function sg_register_post_types()
{
	...
	register_taxonomy('portfolio_category', 'portfolio', array('label' => __('Portfolio Categories', SG_TDN), 'hierarchical' => false));
	register_taxonomy('portfolio_tag', 'portfolio', array('label' => __('Portfolio Tags', SG_TDN), 'hierarchical' => false));
	...
	register_taxonomy('extra_category', 'extra', array('label' => __('Categories', SG_TDN), 'hierarchical' => false));
}