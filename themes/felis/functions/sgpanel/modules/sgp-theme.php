...
//]]>
	...
	public function eCSS()
	{
		...
		echo '<style type="text/css">';
			...
			echo '.nivo-caption p span,.nivo-caption p p,.breadcramp p,.breadcramp span,.tipswift-inner,.proj-img a:hover,.proj-img a.zoom:hover,.search-btn input:hover,ul.accordion li a.title:hover,span.highlight-hl-theme {background-color:' . $acolor . ';}';
		echo '</style>';
