...
//]]>
	...
	public function eTopText()
	{
		if (!empty(self::$_vars['top_text'])) {
			echo '&nbsp;<span class="phone">' . self::$_vars['top_text'] . '</span>';
		}
	}
	
	public function eCopyright()
	{
		echo self::$_vars['copyright'];
	}
	...
	public function eSocial()
	{
		...
		$c = '<div class="float-r social">';
			$c .= '<span class="float-l">' . self::$_vars['soc_txt'] . '</span>';
			$c .= '<ul class="float-r">';

			foreach (self::$_params['social_list'] as $name) {
				if (!empty(self::$_vars[$name])) {
					$c .= '<li><a href="' . self::$_vars[$name] . '" title="' . $titles[$name] . '">';
	...
	{
		return array(
			'title' => self::$_vars['important_title'],
			'text' => self::$_vars['important_text'],
			'filter' => TRUE,
		);
	}
	...
	{
		return array(
			'title' => self::$_vars['contactus_title'],
			'phone' => self::$_vars['contactus_phone'],
			'email' => self::$_vars['contactus_email'],
			'address' => self::$_vars['contactus_address'],
		);
	}
	...
	{
		echo '<span class="float-l">' . self::$_vars['header_text'] . '</span>';
	}
