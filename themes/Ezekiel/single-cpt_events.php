...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
             ...
             <header class="single-header">
				<div>
					<h2><?php the_title(); ?></h2>
					<p><?php the_time('F j, Y'); ?>, <?php the_time('g:i a'); ?>  @ <a href="<?php echo get_post_meta($post->ID, "map", true); ?>" target="_blank"/><?php echo get_post_meta($post->ID, "address", true); ?> | View Map</a></p>
				</div>
