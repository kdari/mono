		...
		<section class="post-list">
            ...
            <li class="article">
                ...
                <aside>
                    ...
                    <p><?php the_time('F j, Y'); ?>, <?php the_time('g:i a'); ?>  @ <a href="<?php echo get_post_meta($post->ID, "map", true); ?>" target="_blank"/><?php echo get_post_meta($post->ID, "address", true); ?> | View Map</a> <?php 
